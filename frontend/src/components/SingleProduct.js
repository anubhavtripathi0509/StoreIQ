...
function SingleProduct(props){
    return(
        ...
        <div className="card">
          <Link to="/products/python-timer/1"><img src={props.product.image} className="card-img-top" alt="..." /></Link>
          <div className="card-body">
            {/* <h4 className="card-title"><Link to='/category/python/1/python-timer-script/1'>{props.title}</Link></h4> */}
            <h4 className="card-title"><Link to={`/products/${props.product.title}/${props.product.id}`}>{props.product.title}</Link></h4>
